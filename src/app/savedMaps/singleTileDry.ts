...
import {  ocean, dry } from '../region/climate';

import { Polity } from '../polity/polity';
import { SavedMap } from './SavedMap';

const singleTileDryRegions = [
...
export const singleTileDry = new SavedMap(singleTileDryRegions,rivers);