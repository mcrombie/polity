...
const riverIntersections:Intersection[] = [
...
const rivers:River[] = [
    new River(riverIntersections)
];

export const allClimatesRiver = new SavedMap(allClimatesRiverRegions,rivers);