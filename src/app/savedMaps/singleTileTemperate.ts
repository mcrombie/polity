...
import {  ocean, temperate } from '../region/climate';

import { Polity } from '../polity/polity';
import { SavedMap } from './SavedMap';

const singleTileTemperateRegions = [
...
export const singleTileTemperate = new SavedMap(singleTileTemperateRegions,rivers);