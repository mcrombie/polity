...
import {  ocean, continental } from '../region/climate';

import { Polity } from '../polity/polity';
import { SavedMap } from './SavedMap';

const singleTileContinentalRegions = [
    ...
    new Region(4,4, ocean, new Polity()),
    new Region(5,4, ocean, new Polity()),
    ...
    new Region(4,5, ocean, new Polity()),
    new Region(5,5, ocean, new Polity()),
    new Region(6,5, ocean, new Polity()),
    new Region(7,5, ocean, new Polity()),
    new Region(8,5, ocean, new Polity()),
    ...
    new Region(4,6, ocean, new Polity()),
    new Region(5,6, ocean, new Polity()),
    new Region(6,6, continental, new Polity()),
    new Region(7,6, ocean, new Polity()),
    new Region(8,6, ocean, new Polity()),
    ...
    new Region(4,7, ocean, new Polity()),
    new Region(5,7, ocean, new Polity()),
    new Region(6,7, ocean, new Polity()),
    new Region(7,7, ocean, new Polity()),
    new Region(8,7, ocean, new Polity()),
    ...
    new Region(4,8, ocean, new Polity()),
    new Region(5,8, ocean, new Polity()),
    new Region(6,8, ocean, new Polity()),
    new Region(7,8, ocean, new Polity()),
    new Region(8,8, ocean, new Polity()),
...
export const singleTileContinental = new SavedMap(singleTileContinentalRegions,rivers);